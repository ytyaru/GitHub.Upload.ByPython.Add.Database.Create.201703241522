...
import os.path
import getpass
import database.src.other_repo.insert.Data
...
class Main:
    def __init__(self, user_name, path_db_account, path_db_other_repo, path_db_license):
        self.data = database.src.other_repo.insert.Data.Data(user_name, path_db_account, path_db_other_repo, path_db_license)
        self.inserter = database.src.other_repo.insert.command.repositories.Inserter.Inserter(self.data)
