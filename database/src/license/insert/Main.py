...
import os.path
import subprocess
import database.src.license.insert.Data
...
class Main:
    def __init__(self, user_name, path_db_account, path_db_repo, path_db_license):
        self.data = database.src.license.insert.Data.Data(user_name, path_db_account, path_db_repo, path_db_license)
        self.licenses = database.src.license.insert.command.miscellaneous.Licenses.Licenses(self.data)
