...
import os.path
import getpass
import database.src.repo.insert.Data
...
class Main:
    def __init__(self, user_name, path_db_account, path_db_repo, path_db_license, path_db_api):
        self.data = database.src.repo.insert.Data.Data(user_name, path_db_account, path_db_repo, path_db_license)
        self.request_param = database.src.repo.insert.github.common.RequestParam.RequestParam(path_db_account, path_db_api, user_name)
